      ...
      <SectionWrapper bg="cream" className="overflow-hidden">
        <Container className="relative">
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            {/* Map preview
                - Naver 와 Kakao 는 X-Frame-Options 로 iframe 임베드가 차단됨
                - 실제 미리보기 가능한 Google Map iframe 으로 복원
                - 국내 사용자 접근성 보완: Naver·Kakao 링크 버튼 병기 (Henry fallback chain) */}
            <div className="flex flex-col gap-3 lg:h-full">
              <div className="bg-white rounded-2xl overflow-hidden flex-1" style={{ border: "1px solid rgba(196, 191, 183, 0.15)" }}>
                <iframe
                  src="https://www.google.com/maps?q=%EC%84%9C%EC%9A%B8+%EC%84%9C%EC%B4%88%EA%B5%AC+%EA%B0%95%EB%82%A8%EB%8C%80%EB%A1%9C+305+%ED%98%84%EB%8C%80%EB%A0%89%EC%8B%9C%EC%98%A8&z=16&output=embed"
                  width="100%"
                  height="100%"
              ...
              <div className="flex flex-wrap gap-2 justify-center lg:justify-start">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white rounded-lg text-xs font-medium text-charcoal hover:bg-cream transition-colors"
                  style={{ border: "1px solid rgba(196, 191, 183, 0.25)" }}
                >
                  네이버 지도 <span aria-hidden="true">↗</span>
                </a>
                <a
                  href="https://map.kakao.com/?q=%EC%84%9C%EC%9A%B8%20%EC%84%9C%EC%B4%88%EA%B5%AC%20%EA%B0%95%EB%82%A8%EB%8C%80%EB%A1%9C%20305%20%ED%98%84%EB%8C%80%EB%A0%89%EC%8B%9C%EC%98%A8"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white rounded-lg text-xs font-medium text-charcoal hover:bg-cream transition-colors"
                  style={{ border: "1px solid rgba(196, 191, 183, 0.25)" }}
                ...
                <a
                  href="https://map.tmap.co.kr/?search=%EC%84%9C%EC%9A%B8%20%EC%84%9C%EC%B4%88%EA%B5%AC%20%EA%B0%95%EB%82%A8%EB%8C%80%EB%A1%9C%20305"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white rounded-lg text-xs font-medium text-charcoal hover:bg-cream transition-colors"
                  style={{ border: "1px solid rgba(196, 191, 183, 0.25)" }}
                >
                  티맵 <span aria-hidden="true">↗</span>
                </a>
              </div>
            </div>
          </div>
