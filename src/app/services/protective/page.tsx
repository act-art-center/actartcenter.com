...
const partnershipModels = [
  ...
  },
  {
    ...
    description:
      "의료기관이 담당 환자의 심리 보조 자원으로 본 센터를 추천·연계하는 구조입니다. 참여자는 외래 형태로 센터를 방문하며, 동의 범위 안에서 세션 경과를 의료진과 공유합니다.",
  },
  {
    number: "03",
...
const adolescentProtocol = [
  ...
  },
  {
    title: "집단 역동 관리",
    description:
      "보호병동 집단 세션은 2~6명 규모, 공동 작업과 개별 작업을 병행합니다. 집단 내 서열·폭력적 상호작용을 예방하기 위한 규칙을 첫 회기에 함께 정합니다.",
  },
  {
    title: "위기 대응 프로토콜",
    description:
        ...
        <Container>
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="mt-2 text-charcoal/70 text-sm leading-relaxed">
                차 의과학대학교 의학과 임상미술치료 박사과정인 원장의 임상 배경과
                연구 관심을 확인하실 수 있습니다.
              </p>
            </Link>
          </div>
