...
const whereItHelps = [
  ...
  },
  {
    title: "또래 관계 · 따돌림 경험",
    description:
      "말로 다 꺼내지 못한 관계의 상처를 은유적으로 다룹니다. 치료실 안에서 '나와 친구'의 관계 지도를 그리며 대처 방식을 함께 설계합니다.",
  },
  {
    title: "학교 적응 · 등교 거부",
    description:
...
const sessionFlow = [
  {
    step: "1",
    title: "웜업 (5분)",
    description: "오늘의 마음 상태를 색·기호로 체크인. 치료실이 안전한 공간임을 몸으로 다시 등록합니다.",
  },
  {
    step: "2",
    title: "주제 작업 (25~30분)",
...
const parentFaq = [
  ...
  },
  {
    ...
    a: "첫 회기에 바로 작업을 강요하지 않습니다. 치료실 공간을 둘러보는 것부터 시작해, 아이의 속도에 맞추어 관계를 쌓습니다. 2~3회기 동안 '오기 싫지 않은 공간'으로 자리잡는 것이 목표입니다.",
  },
  {
    q: "미술을 못하는 아이도 괜찮나요?",
    a: "네. 미술치료는 기술 학습이 아닙니다. 선 하나, 색 한 덩어리, 찢은 종이도 모두 표현으로 존중됩니다. 오히려 '잘 그려야 한다'는 부담을 내려놓는 경험 자체가 치료의 일부가 됩니다.",
  },
  {
    q: "심리검사가 꼭 필요한가요?",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            <div>
              ...
              <p className="mt-4 text-charcoal/80 leading-[var(--leading-normal)]">
                본 센터의 10분 부모 상담은 '가정에서의 일주일'과 '치료실에서의
