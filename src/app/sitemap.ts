...
const PAGE_LAST_MODIFIED: Record<string, string> = {
  ...
  "/services/open-studio": "2026-07-20",
  "/services/drawing-assessment": "2026-07-20",
  "/services/tci": "2026-07-29",
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    entry("/services/open-studio", 0.8, "monthly"),
    entry("/services/drawing-assessment", 0.8, "monthly"),
    entry("/services/tci", 0.8, "monthly"),
