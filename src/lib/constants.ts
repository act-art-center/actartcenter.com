...
export const SERVICES_ALL = [
  {
    ...
    description: "여기에서 미술치료를 중심으로 ACT는 보조적으로 통합됩니다. 50분 세션으로 불안·우울·번아웃·트라우마·관계 갈등을 다룹니다.",
  ...
  },
  {
    ...
    href: "/services/group",
    anchor: "2~6인 그룹 프로그램",
    image: "/characters/twins-together.png",
  ...
  },
  {
    ...
    image: "/characters/actie/actie-holding-heart.jpg",
