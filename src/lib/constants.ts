...
export const TEAM_MEMBERS = [
  {
    ...
    bio: "세 아이의 어머니이자 미술심리치료사입니다. 홍익대학교에서 미술학 석사 및 학사를 마친 후 서울디자인재단 DDP 전시기획을 하며 예술 현장의 실무 경험을 쌓았습니다. 차 의과학대학교 임상미술치료 석사 이후, 현재는 의학과 박사 과정 중에 미술을 통한 정서 회복에 대한 연구를 이어가고 있습니다.",
    quote:
