...
export const FAQ_CATEGORIES: ReadonlyArray<{
  ...
  },
  {
    id: "process",
    title: "진행 과정",
    description: "회기 간격·기간·종결까지, 치료의 흐름을 안내합니다.",
  },
  {
    id: "pricing",
    title: "비용·결제",
...
export const FAQ_ITEMS: ReadonlyArray<{
  ...
  // ── 진행 과정 ───────────────────────────────────────────────────
  {
    ...
    answer:
      "국제 연구에 따르면 단기 개입은 6~8회, 중기 개입은 12~16회, 복합적 주제나 트라우마 작업은 20회 이상이 권장됩니다. 센터에서는 첫 회기 이후 초기 목표를 함께 정하고 4~6회마다 경과를 점검합니다. 단기간에 변화가 필요하신 경우 8주 집중 프로그램도 마련되어 있습니다.",
  },
  {
    category: "process",
    question: "회기 간격은 보통 어떻게 정하나요?",
    answer:
      "초반 4~6주는 주 1회 간격을 권장합니다. 정서적 연결과 치료 효과가 안정적으로 쌓이기 위해서는 일정한 리듬이 중요하기 때문입니다. 이후 안정기에 접어들면 격주 또는 월 1회로 간격을 늘리며 마무리 단계로 이어갑니다.",
  },
  {
    category: "process",
    question: "중간에 치료를 그만두고 싶어지면 어떻게 하나요?",
    answer:
      "언제든 의사를 말씀해 주세요. 일방적 중단보다는 1~2회의 종결 회기를 통해 지금까지의 작업을 정리하시는 것을 권장드립니다. 이는 치료 과정에서의 변화를 내면에 안정적으로 통합하는 데 중요하기 때문입니다. 비용·일정상 어려움이 있으시면 조정도 가능합니다.",
  },
  {
    category: "process",
    question: "치료 종결은 어떤 기준으로 결정하나요?",
    answer:
  ...
  },
  {
    ...
    answer:
      "내담자의 작품은 내담자의 소유입니다. 원하시면 가져가실 수 있고, 센터에 안전하게 보관해 드리는 것도 가능합니다. 촬영한 기록은 비밀 보장 원칙에 따라 치료사만 접근할 수 있는 공간에 보관되며, 치료 종결 후에는 동의하신 방식으로 처리됩니다.",
  },
  ...
  {
    category: "pricing",
    question: "카드 결제와 현금영수증이 가능한가요?",
    answer:
      "카드·계좌이체 모두 가능하며 현금영수증 발행도 가능합니다. 세금계산서가 필요한 기업·기관 대상 워크숍의 경우 사전에 담당자와 상의해 발급해 드립니다.",
  },
  {
    category: "pricing",
  ...
  },
  {
    ...
    answer:
      "8주 집중 프로그램·번아웃 워크숍·가족 세션 등 패키지 이용 시 단일 회기 대비 약 10~15% 할인이 적용됩니다. 이는 ‘지속적 작업이 변화를 만든다’는 임상 근거(치료 용량-반응 관계)에 기반한 구성입니다.",
  },
  ...
  },
  {
    ...
    answer:
      "아이의 비밀유지도 치료 신뢰의 핵심입니다. 생명·안전과 관련된 사안이 아니라면, 개별 발언을 그대로 전달하기보다 아이의 정서 상태·성장 지점 위주로 공유해 드립니다. 첫 회기 때 가족 구성원이 함께 비밀유지 범위를 확인합니다.",
  },
  {
    category: "child",
    question: "학교나 담임 선생님과도 협력이 가능한가요?",
    answer:
      "부모의 동의가 있는 경우 학교 상담 교사나 담임 선생님과 제한적 범위에서 소통이 가능합니다. 진단서 발급은 의료기관의 영역이므로 불가하지만, 치료 진행 상황에 대한 간단한 의견서는 제공해 드릴 수 있습니다.",
  },
  ...
  // ── 온라인 ──────────────────────────────────────────────────────
  {
    ...
    answer:
      "화상 미팅(Zoom)으로 진행됩니다. 사전에 미술 재료 키트를 배송해 드리며, 치료사의 안내에 따라 함께 미술 활동을 합니다. 국내외 연구에서도 대면과 온라인 상담의 치료 동맹·효과 차이가 유의미하지 않다는 결과가 꾸준히 보고되고 있습니다.",
  },
  {
    category: "online",
...
export const TEAM_MEMBERS = [
  {
    ...
    philosophyParagraphs: [
      ...
      "그러나 감정을 꺼내는 것만으로는 삶이 달라지지 않습니다. 수용전념치료(ACT)는 드러난 감정에 휩쓸리는 대신 ‘그 감정을 품고도 내가 원하는 방향으로 걸어갈 수 있는 힘’, 즉 심리적 유연성을 훈련합니다. 미술이 ‘안전한 거리에서 꺼내 보는 작업’이라면, ACT는 ‘꺼낸 것을 어떻게 다룰지 방향을 세우는 작업’입니다. 두 접근이 만났을 때 치료는 감정 해소에서 멈추지 않고 일상의 선택으로 이어집니다.",
