...
export const CONTACT = {
  ...
  address: "서울시 서초구 강남대로 305, 현대렉시온 2519호",
} as const;
...
export const SERVICES_ALL = [
  {
    ...
    image: "/characters/session/adult-individual-art-therapy-transparent.webp",
  ...
  },
  {
    ...
    description: "2~6인 소그룹으로 함께하는 ACT 미술치료. 마음유연성 8주, 번아웃 탈출 워크숍, 테마별 단기 그룹 3가지.",
    href: "/services/group",
    anchor: "2~6인 그룹 프로그램",
    image: "/characters/twins-together-transparent.webp",
    imageAlt: "ACTIE와 ARTTY가 함께 있는 그룹 미술치료 안내 장면",
    group: "adult",
  },
  {
    id: "child",
    ...
    imageAlt: "ARTTY가 점토 곰 인형을 들고 있는 아동 미술치료 장면",
    group: "adult",
  },
  {
    id: "online",
    ...
    description: "Zoom 화상 + 미술 매체 키트 자택 배송. 전국 어디서나, 해외 거주 한국인도 참여 가능한 비대면 미술치료.",
    href: "/services/online",
    anchor: "전국 온라인 미술치료",
    image: "/images/online-art-therapy.jpg",
    imageAlt: "한 사람이 노트북으로 편안하게 온라인 미술치료에 참여하는 장면",
    group: "adult",
  },
  {
    id: "protective",
    ...
    image: "/characters/actie/actie-holding-heart-transparent.webp",
    imageAlt: "ACTIE가 마음을 안전하게 돌보는 보호·의료 환경 미술치료 장면",
    group: "specialty",
  },
  {
    id: "emotional",
    ...
    image: "/characters/session/emotional-trauma-art-therapy-transparent.webp",
  ...
  },
  {
    ...
    imageAlt: "ACTIE가 망원경으로 가치와 방향을 바라보는 심층 탐색 장면",
    group: "specialty",
  },
] as const;
...
export const FAQ_ITEMS: ReadonlyArray<{
  ...
  {
    category: "act",
    question: "수용전념치료 기법은 세션에서 어떻게 쓰이나요?",
    answer:
      "ACT 미술치료에서는 감정을 없애는 연습보다, 감정이 있는 상태에서 내가 소중히 여기는 방향을 찾는 연습을 합니다. 그림·색·상징을 사용해 수용, 탈융합, 현재 순간 접촉, 가치 탐색을 몸으로 경험하도록 안내합니다.",
  },
  {
    category: "act",
    question: "수용전념치료 육각형은 무엇인가요?",
    answer:
      "수용전념치료 육각형은 심리적 유연성을 이루는 여섯 과정입니다. 수용, 탈융합, 현재 순간, 맥락으로서의 자기, 가치, 전념 행동이 서로 연결되어 있고, 미술치료에서는 이 과정을 이미지와 작업 흐름으로 천천히 살핍니다.",
  },
  ...
  // ── 아동·청소년 ─────────────────────────────────────────────────
  {
    ...
    answer:
      "만 5세부터 참여 가능합니다. 아동의 발달 단계에 맞춰 미술 매체와 표현 과정을 중심으로 진행하며, 매 세션 후 부모 상담 10분이 포함됩니다. 만 14세 이상 청소년은 성인 개인 세션 구성에 가깝게 진행됩니다.",
  },
  {
    category: "child",
...
export const TEAM_MEMBERS = [
  {
    ...
    education: [
      "차 의과학대학교 의학과 임상미술치료 박사과정, 석사",
      "홍익대학교 미술학 석사, 학사",
    ],
    specialties: ["미술심리치료", "ACT(수용전념) 미술치료", "트라우마", "정서·심층탐색"],
    bio: "세 아이의 어머니이자 미술심리치료사. 홍익대학교에서 미술학 석사 및 학사를 마친 후 서울디자인재단 DDP(동대문디자인플라자) 전시기획을 하며 예술 현장의 실무 경험을 쌓았습니다. 차 의과학대학교 임상미술치료 석사 이후, 현재는 의학과 박사 과정 중에 미술을 통한 정서 회복에 대한 연구를 이어가고 있습니다.",
    quote:
    ...
    specialtyDetails: [
      ...
      },
      {
        title: "아동 청소년 미술치료",
        description:
          "발달 단계에 맞춘 미술 매체와 표현 과정을 통해 아동과 청소년이 자기감정을 안전하게 표현하도록 돕습니다. 부모 상담 10분이 포함되어 가정에서의 반응 전략도 함께 설계합니다.",
      },
    ],
    /** 연구 관심사 — 박사 과정 연구 방향. 허구 없이 일반화된 관심사. */
    researchInterests: [
      "AI 보조 미술표현을 활용한 미술치료 경험에 관한 연구",
      "호스피스 완화의료 환경에서 말기 암 환자가 경험하는 미술치료의 의미: 정신종양학적 관점을 중심으로",
      "보육시설 거주 아동을 대상으로 한 Holding Environment 기반 미술치료 연구",
      "자유만다라를 활용한 ACT(수용전념) 미술치료 경험에 관한 연구",
    ],
    ...
    firstSessionFlow: [
      ...
      },
      {
        ...
        minutes: "약 10분",
        description:
          "작업한 것을 두고 ‘해석’ 이 아니라 ‘대화’ 를 나눕니다. 작품에 대한 정답은 없으며, 내담자와의 대화가 언제나 가장 신뢰할 만한 단서가 됩니다.",
      },
      {
        step: "프로그램 설계 & 마무리",
        minutes: "약 5~10분",
        description:
          "오늘의 경험을 바탕으로 적합한 회기 수·간격·접근 방식을 함께 이야기합니다. 결정을 그 자리에서 하지 않으셔도 됩니다. 가능성만 열어두고 돌아가셔도 좋습니다.",
      },
    ],
  },
] as const;
