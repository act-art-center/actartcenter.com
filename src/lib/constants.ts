...
export const SITE_DESCRIPTION =
  "액트 아트 센터는 미술을 경험하며 마음이 잠시 쉬어갈 수 있는 안전한 시간을 함께합니다.";
...
export const TEAM_MEMBERS = [
  {
    ...
    specialtyDetails: [
      ...
      },
      {
        title: "아동 청소년 미술치료",
        description:
          "발달 단계에 맞춘 미술 재료와 놀이적 접근을 통해 아이와 청소년이 자기감정을 안전하게 표현하도록 돕습니다. 부모 상담 10분이 포함되어 가정에서의 반응 전략도 함께 설계합니다.",
      },
      {
        title: "그룹 미술치료(3-4인)",
        description:
          "3-4인이 함께하는 소그룹 미술치료입니다. 각자의 작업을 존중하며 색·이미지·상징을 나누는 과정에서 자기이해, 정서 조절, 관계 안에서의 안전감을 함께 경험합니다.",
      },
      {
        title: "온라인 미술치료",
        description:
