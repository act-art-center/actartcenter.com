...
export const TEAM_MEMBERS = [
  {
    ...
    philosophyParagraphs: [
      ...
      "저는 지금 이 자리에 서 있기 위해 각자가 치러 온 고유한 노력을 먼저 존중하며, 그 위에 조금 더 유연한 선택지를 함께 탐색합니다. 예술은 그 선택을 내면에서 가시적인 형태로 꺼내 주고, ACT는 그 선택이 단단히 뿌리내리도록 돕습니다.",
    ],
    ...
    specialtyDetails: [
      ...
      {
        title: "ACT 기반 성인 미술치료",
        description:
          "불안·우울·번아웃·관계 갈등을 미술 작업 안에서 안전하게 바라보며, ACT 관점을 보조적으로 통합해 감정과 관계 맺는 방식을 다시 설계합니다. 미술은 감정과 만나는 통로, ACT는 삶의 방향을 확인하는 나침반 역할을 합니다.",
      },
      {
        title: "정서·심층탐색",
        description:
