...
export const SERVICES_ALL = [
  ...
  },
  {
    ...
    image: "https://source.unsplash.com/800x600/?art-therapy,painting-hands,drawing-hands",
    imageAlt: "사람들이 함께 그림을 그리는 손이 보이는 미술치료 장면",
    group: "specialty",
  },
  {
    id: "emotional",
...
export const TEAM_MEMBERS = [
  {
    ...
    bio: "세 아이의 어머니이자 미술심리치료 전문가. 홍익대학교에서 미술학 학사 및 석사를 마친 후 서울디자인재단 DDP 전시기획을 하며 예술 현장의 실무 경험을 쌓았다. 차의과학대학교임상미술치료 석사 이후, 현재는 의학과 박사 과정 중에 미술을 통한 정서 회복에 대한 연구를 이어가고 있다.",
    quote:
