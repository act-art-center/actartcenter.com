...
export const SERVICES_ALL = [
  ...
  },
  {
    ...
    description: "만 5세부터 청소년까지. 발달 단계에 맞춰 미술 매체와 표현 과정으로 접근하는 맞춤 미술치료. 부모 상담 10분 포함.",
    href: "/services/child",
...
export const TEAM_MEMBERS = [
  {
    ...
    bio: "세 아이의 어머니이자 미술심리치료사. 홍익대학교에서 미술학 석사 및 학사를 마친 후 서울디자인재단 DDP(동대문디자인프라자) 전시기획을 하며 예술 현장의 실무 경험을 쌓았습니다. 차 의과학대학교 임상미술치료 석사 이후, 현재는 의학과 박사 과정 중에 미술을 통한 정서 회복에 대한 연구를 이어가고 있습니다.",
    quote:
    ...
    specialtyDetails: [
      ...
      },
      {
        title: "그룹 미술치료(2-6인)",
        description:
          "2-6인이 함께하는 소그룹 미술치료입니다. 각자의 작업을 존중하며 색·이미지·상징을 나누는 과정에서 자기이해, 정서 조절, 관계 안에서의 안전감을 함께 경험합니다.",
      },
      {
        title: "온라인 미술치료",
        description:
          "온라인 세션 전 준비할 기본 매체를 사전에 안내해 드립니다. 세션 주제에 따라 필요한 특별한 매체가 있는 경우 센터에서 미리 송부해 드립니다.",
      },
    ],
