...
export const TEAM_MEMBERS = [
  {
    ...
    bio: "세 아이의 어머니이자 미술심리치료 전문가. 홍익대학교에서 미술학 학사 및 석사를 마친 후 서울디자인재단 DDP 전시기획을 하며 예술 현장의 실무 경험을 쌓았다. 이후 차의과학대학교에서 임상미술치료 석사공부를 마쳤다. 현재 의학과 박사 과정을 이수하며 미술을 통한 정서 회복과 인간 이해에 대한 연구를 이어가고 있다.",
    quote:
