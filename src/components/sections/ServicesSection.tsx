      ...
      <Container>
        ...
        <div className="mt-12 lg:mt-16">
          <div className="flex flex-col items-end gap-2 mb-5 lg:flex-row lg:items-baseline lg:justify-between">
            <h3 className="w-full whitespace-nowrap text-[clamp(0.8rem,3vw,1.375rem)] font-semibold leading-tight tracking-tight text-night">
            ...
            >
              <span className="block whitespace-nowrap">세션 비용 안내</span>
