      ...
      <Container>
        ...
        <div className="mt-12 lg:mt-16">
          <div className="flex flex-col items-end gap-2 mb-5 lg:flex-row lg:items-baseline lg:justify-between">
            <h3 className="w-full min-w-0 flex-1 text-night text-xl font-semibold tracking-tight">
        ...
        <div className="mt-14 lg:mt-16">
          <div className="flex items-baseline justify-between mb-5">
            <h3 className="text-night text-xl font-semibold tracking-tight">아동부터 성인, 모두를 위한 미술치료</h3>
            <Link
              href="/pricing"
